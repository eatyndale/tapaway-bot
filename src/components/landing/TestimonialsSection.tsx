...
const testimonials = [
  {
    name: "Jennifer O.",
    quote:
      "As soon as I start tapping I instantly feel calmer. I use it every day and am a totally different person from the one I was pre Tapaway.",
    rating: 5,
  ...
  },
  {
    name: "Amarachi E.",
    quote:
      "Tapping has helped me to get rid of anxiety. I used to wake up anxious... It doesn't happen often now, but if it does I simply tap it away!",
    rating: 5,
    ...
    <section className="py-20 bg-gradient-to-b from-background to-muted/30">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-heading font-bold text-foreground mb-4">Why People Love Tapaway</h2>
